...
-(void)getShopData{
    ...
    [[NetworkSingleton shareManager] getShopResult:nil url:urlStr successBlock:^(id responseBody){
        NSLog(@"店铺详情请求成功");
...
-(void)getShopRecommendData{
    ...
    [[NetworkSingleton shareManager] getShopRecommendResult:nil url:urlStr successBlock:^(id responseBody){
        NSLog(@"店铺推荐请求成功");
